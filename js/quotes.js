$(document).ready(function() {
    ...
    function getHardcodedQuote() {
        ...
        $("#quote").hide().fadeIn(2500).text('"' + quotes[random] + '"');
        $("#author").hide().fadeIn(2500).text('- ' + authors[random]);
    }
        ...
        if (randomNumber <= 20) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#quote').hide().fadeIn(2500).text('"' + data.quote + '"');
                    $('#author').hide().fadeIn(2500).text('- ' + data.author);
                },
